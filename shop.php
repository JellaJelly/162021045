                                                ...
                                                <ul class="nice-scroll">
                                                    <li>
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check_label" for="product_category">Sepatu</label>
                                                        </div>
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check_label" for="product_category">Jaket</label>
                                                        </div>
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check_label" for="product_category">Kaos</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="sepatu"
                                                                name="product_category" id="category_one"
                                                        ...
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check_label" for="product_category">Syal</label>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <h5><?php echo setRupiah(($row['product_price'] * $kurs_dollar));?>
                                    </h5>
