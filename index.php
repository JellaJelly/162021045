...
include('server/controller_limit_blog.php');
...
?>
    ...
    <section class="latest spad">
        <div class="container">
            ...
            <div class="row">
            <?php while($blog = $limit_blogs->fetch_assoc()) { ?>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<?php echo 'img/blog/'.$blog['blog_image']; ?>"></div>
                        <div class="blog__item__text">
                            <span><img src="img/icon/calendar.png" alt=""> <?php echo date('d F Y', strtotime($blog['blog_date'])); ?></span>
